...
If your team keeps the notebook under a different final name, update the README to match before submission.
...
If your team later splits the project into separate ETL, EDA, and analysis notebooks, update this section so the grader can run them in order.
